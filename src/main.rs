...
fn main() {
  let mut graphics = CoreMaat::new("AiTestingGrounds".to_string(), (MAJOR) << 22 | (MINOR) << 12 | (PATCH), 1280.0, 1080.0, true);
  ...
  graphics.preload_texture(String::from("Rocket"), 
                           String::from("./resources/Rocket.png"));
  graphics.preload_texture(String::from("DeadRocket"), 
                           String::from("./resources/DeadRocket.png"));
